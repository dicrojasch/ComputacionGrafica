...
' Ruta donde se guardan los archivos (plantilla del correo, archivo que se va enviar adjunto)
...
Sub InMail(mail As Outlook.MailItem) '
    ...
    If Not objetoJson Is Nothing Then
        If "formaleta" = objetoJson.Item("formulario") Then
            ...
            'producto.setFormaleta (formaleta)
        ...
        ElseIf "invernadero" = objetoJson.Item("formulario") Then
            ...
            'producto.setInvernadero (invernadero)
            ' TODO : excel
